...
export const gridItems = [
  ...
  {
    id: 5,
    title: "Currently working on building the next generation of Product Analytics Platform",
...
export const blogs = [
  {
    id: 1,
    title:
      "Microsoft’s Majorana 1 Chip: The Future of Quantum Computing Has Arrived",
    description:
